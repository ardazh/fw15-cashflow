          ...
          <form className='w-[80%] flex flex-col justify-center'>
            ...
            <div className='flex flex-col gap-4'>
                <div className='flex mt-16'>
                    ...
                    <input className='input w-full outline-none border-0 hover:outline-none hover:border-0' placeholder='Insert Code' />
                    </div>
                </div>
                <div className='flex'>
                    <div className='flex items-center gap-3 border-b-2'>
                ...
                <div className='flex items-center gap-3 border-b-2'>
                    ...
                    <input className='input w-full outline-none border-0 hover:outline-none hover:border-0' placeholder='Confirm password' />
                </div>
            </div>
